...
--transmitflag2 envía a de infor a Portal.
...
select status, * from [SCMC1].wmwhse1.ORDERS where EXTERNORDERKEY like '%000000136841%'

select * from [SCMC1].wmwhse1.ORDERDETAIL where EXTERNORDERKEY = '0391545797'

select * from [SCMC1].wmwhse1.TRANSMITLOG where key1 in('0000045510') and TABLENAME ='customerorderstaged'

update [SCMC1].wmwhse1.TRANSMITLOG set TRANSMITFLAG2 = 0 where key1 in('0000045510') and TABLENAME ='customerorderstaged'
