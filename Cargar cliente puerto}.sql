declare @Operacion as int = 1008
declare @IdPortal as int = 853
declare @IdFleet as int = 6424
...
select * from PL_USERS_CUSTOMERS where IDCUSTOMER=853


select * from UNIGIS_DataRepository.dbo.Cliente where RazonSocial like '%OFFAL%'


select * from PL_CUSTOMERS where CUSTOMER like '%OFFAL%'


select * from UNIGIS_DataRepository.dbo.OperacionCliente where IdCliente=6424 --where RazonSocial like '%OFFAL%'
